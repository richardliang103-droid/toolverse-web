...
export function BackgroundRemover() {
  ...
  function handoffFile() {
    ...
    if (!blob) return null;
    return toHandoffFile(blob, `${(file?.name ?? "image").replace(/\.[^.]+$/, "")}-去背.png`);
  }
