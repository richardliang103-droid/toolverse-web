...
export function TextCleanerTool() {
  ...
  return <section className="workspace text-cleaner-workspace page-shell" aria-label="文字清理工具">
    <div className="panel">
      <div className="panel-header"><h2>原始文字</h2><span className="panel-meta"><CountUp value={inputStats.characters} /> 字 · <CountUp value={inputStats.words} /> 詞 · <CountUp value={inputStats.lines} /> 行</span></div>
    ...
    <div className="panel panel-tinted">
      <div className="panel-header"><h2>清理結果</h2><span className="panel-meta"><CountUp value={outputStats.characters} /> 字 · <CountUp value={outputStats.words} /> 詞 · <CountUp value={outputStats.lines} /> 行 · <CountUp value={outputStats.uniqueLines} /> 不重複</span></div>
